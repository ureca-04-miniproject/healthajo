...
(
    ...
    reservation_open_at  DATETIME     NOT NULL COMMENT '예약 시작일시',
    reservation_close_at DATETIME     NOT NULL COMMENT '예약 종료일시',
    cancellation_open_at   DATETIME     NOT NULL COMMENT '취소 시작일시',
    cancellation_close_at  DATETIME     NOT NULL COMMENT '취소 종료일시',
    created_at       DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at       DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deleted_at       DATETIME     NULL COMMENT '소프트 삭제',
