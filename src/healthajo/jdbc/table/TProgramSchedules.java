...
public final class TProgramSchedules extends TableBase {
    ...
    public final Column<LocalDateTime>  START_DATE                          = new Column<>(getTableName(), "start_date", LocalDateTime.class);
    public final Column<LocalDateTime>  END_DATE                            = new Column<>(getTableName(), "end_date", LocalDateTime.class);
